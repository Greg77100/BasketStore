...
#[ORM\Entity(repositoryClass: ShippingAdressOrderRepository::class)]
class ShippingAdressOrder
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToOne(inversedBy: 'shippingAdressOrder', targetEntity: Order::class)]
